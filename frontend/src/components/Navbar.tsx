...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-[70px] bg-[#faf8f6] flex items-center justify-between px-[56px] py-[8px] shadow-[0px_5px_10px_0px_rgba(0,0,0,0.15)] w-full">
      {/* Logo */}
