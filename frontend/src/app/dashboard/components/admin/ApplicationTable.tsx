...
export function ApplicationTable({
  ...
  const handleSaveEdit = async (clientNumber: string, patch: ApplicantEditPatch, rowId: string) => {
    ...
    const nextApplicant: Applicant = {
      ...
      educationStatus: patch.educationStatus ? patch.educationStatus.split(", ") : undefined,
      employmentStatus: patch.employmentStatus ? patch.employmentStatus.split(", ") : undefined,
